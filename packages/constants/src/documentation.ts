...
export const DOCUMENTATION_QUOTA_DIMENSIONS = [
  "active_sites",
  "active_pages",
  "retained_file_bytes",
] as const;
export const DOCUMENTATION_LIMIT_STATES = [
  "within_limit",
  "at_limit",
  "over_limit",
] as const;
export const DOCUMENTATION_PROJECTION_KINDS = [
  "draft_search",
  "publication_search",
] as const;
export const DOCUMENTATION_PROJECTION_REBUILD_OUTCOMES = [
  "rebuilt",
  "unchanged",
] as const;

export const DOCUMENTATION_HEAVY_WORK_CONCURRENCY_MIN = 1;
export const DOCUMENTATION_HEAVY_WORK_CONCURRENCY_DEFAULT = 2;
export const DOCUMENTATION_HEAVY_WORK_CONCURRENCY_MAX = 16;
export const DOCUMENTATION_PUBLICATION_CONCURRENCY_MIN = 1;
export const DOCUMENTATION_PUBLICATION_CONCURRENCY_DEFAULT = 2;
export const DOCUMENTATION_PUBLICATION_CONCURRENCY_MAX = 16;
export const DOCUMENTATION_REBUILD_CONCURRENCY_MIN = 1;
export const DOCUMENTATION_REBUILD_CONCURRENCY_DEFAULT = 1;
export const DOCUMENTATION_REBUILD_CONCURRENCY_MAX = 4;
export const DOCUMENTATION_PUBLICATION_TIMEOUT_MIN_MS = 10_000;
export const DOCUMENTATION_PUBLICATION_TIMEOUT_DEFAULT_MS = 300_000;
export const DOCUMENTATION_PUBLICATION_TIMEOUT_MAX_MS = 1_800_000;
export const DOCUMENTATION_REBUILD_BATCH_SIZE_MIN = 1;
export const DOCUMENTATION_REBUILD_BATCH_SIZE_DEFAULT = 100;
export const DOCUMENTATION_REBUILD_BATCH_SIZE_MAX = 500;
export const DOCUMENTATION_INITIAL_HTML_MAX_BYTES_MIN = 1024 * 1024;
export const DOCUMENTATION_INITIAL_HTML_MAX_BYTES_DEFAULT = 16 * 1024 * 1024;
export const DOCUMENTATION_INITIAL_HTML_MAX_BYTES_MAX = 32 * 1024 * 1024;
export const DOCUMENTATION_TRY_IT_DNS_TIMEOUT_MIN_MS = 250;
export const DOCUMENTATION_TRY_IT_DNS_TIMEOUT_DEFAULT_MS = 2_000;
export const DOCUMENTATION_TRY_IT_DNS_TIMEOUT_MAX_MS = 10_000;
export const DOCUMENTATION_PUBLIC_METADATA_TITLE_MAX = 200;
export const DOCUMENTATION_PUBLIC_METADATA_DESCRIPTION_MAX = 1_000;
