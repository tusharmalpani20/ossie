...
export const InteractiveDemoVersionQuerySchema = z
  .object({
    project_version_id: TrimmedIdParamSchema,
  })
  .strict();
export type InteractiveDemoVersionQuery = z.infer<
  typeof InteractiveDemoVersionQuerySchema
>;

export const InteractiveDemoArtifactSchema = z
  .object({
    id: IdSchema,
  ...
  .strict();
export type InteractiveDemoArtifact = z.infer<
  typeof InteractiveDemoArtifactSchema
>;

export const InteractiveDemoEditionSchema = z
  .object({
    id: IdSchema,
    organization_id: IdSchema,
    project_id: IdSchema,
  ...
  .strict();
export type InteractiveDemoEdition = z.infer<
  typeof InteractiveDemoEditionSchema
>;

export const InteractiveDemoWorkingDraftSchema = z
  .object({
    id: IdSchema,
    organization_id: IdSchema,
    project_id: IdSchema,
  ...
  .strict();
export type InteractiveDemoWorkingDraft = z.infer<
  typeof InteractiveDemoWorkingDraftSchema
>;
...
export const DemoTransitionSchema = z
  .object({
    id: IdSchema,
    organization_id: IdSchema,
    project_id: IdSchema,
...
export const DemoHotspotSchema = z
  .object({
    id: IdSchema,
    organization_id: IdSchema,
    project_id: IdSchema,
...
const DemoTransitionInputSchema = z
  .object({
    target_scene_id: TrimmedIdParamSchema,
  })
  .strict();

export const CreateInteractiveDemoRequestSchema = z
  .object({
    project_version_id: TrimmedIdParamSchema,
  ...
  .strict();
export type CreateInteractiveDemoInput = z.infer<
  typeof CreateInteractiveDemoRequestSchema
> & {
  source_capture_session_id?: string | null;
};

export const CreateInteractiveDemoFromCaptureRequestSchema = z
  .object({
...
export const UpdateInteractiveDemoRequestSchema = z
  .object({
    title: TrimmedNonEmptyStringSchema.optional(),
    description: z.string().nullable().optional(),
  ...
  .strict();
export type UpdateInteractiveDemoInput = z.infer<
  typeof UpdateInteractiveDemoRequestSchema
>;

export const UpdateInteractiveDemoEditionStatusRequestSchema = z
  .object({
    expected_edition_version: RowVersionSchema,
  })
  .strict();

export const CreateDemoSceneRequestSchema = z
  .object({
  ...
  .strict();
export type CreateDemoSceneInput = z.infer<
  typeof CreateDemoSceneRequestSchema
> & {
  source_capture_session_id?: string | null;
...
export const ReorderDemoScenesRequestSchema = z
  .object({
    scene_ids: z.array(TrimmedIdParamSchema).min(1),
    expected_working_draft_version: RowVersionSchema,
  })
  .strict();
export type ReorderDemoScenesInput = z.infer<
  typeof ReorderDemoScenesRequestSchema
>;

export const CreateDemoHotspotRequestSchema = z
  .object({
    hotspot_type: z.enum(DEMO_HOTSPOT_TYPES),
  ...
  .strict();
export type CreateDemoHotspotRequest = z.infer<
  typeof CreateDemoHotspotRequestSchema
>;
...
export const UpdateDemoHotspotRequestSchema = z
  .object({
  ...
  .strict();
export type UpdateDemoHotspotRequest = z.infer<
  typeof UpdateDemoHotspotRequestSchema
>;
...
export const ReorderDemoHotspotsRequestSchema = z
  .object({
    hotspot_ids: z.array(TrimmedIdParamSchema).min(1),
    expected_working_draft_version: RowVersionSchema,
  })
  .strict();
export type ReorderDemoHotspotsInput = z.infer<
  typeof ReorderDemoHotspotsRequestSchema
>;

export const InteractiveDemoContentDeleteQuerySchema =
  InteractiveDemoVersionQuerySchema.extend({
    expected_working_draft_version: z.coerce.number().int().positive(),
  }).strict();

export const InteractiveDemoSummarySchema = z
  .object({
...
export const InteractiveDemoDetailResponseSchema =
  InteractiveDemoSummarySchema.extend({
...
export const InteractiveDemoWorkingDraftMutationResponseSchema = z
  .object({
    working_draft: InteractiveDemoWorkingDraftSchema,
  })
  .strict();
export type InteractiveDemoWorkingDraftMutationResponse = z.infer<
  typeof InteractiveDemoWorkingDraftMutationResponseSchema
>;
...
export const CreateInteractiveDemoResponseSchema =
  InteractiveDemoDetailResponseSchema;
export type CreateInteractiveDemoResponse = z.infer<
  typeof CreateInteractiveDemoResponseSchema
>;

export const ProjectInteractiveDemoListResponseSchema = z
  .object({
...
export const InteractiveDemoSceneResponseSchema = z
  .object({
    demo_scene: DemoSceneSchema,
    working_draft: InteractiveDemoWorkingDraftSchema,
  })
  .strict();
export type InteractiveDemoSceneResponse = z.infer<
  typeof InteractiveDemoSceneResponseSchema
>;
export type InteractiveDemoSceneUpdateResponse = InteractiveDemoSceneResponse;

export const InteractiveDemoSceneListResponseSchema = z
  .object({
    demo_scenes: z.array(DemoSceneSchema),
    working_draft: InteractiveDemoWorkingDraftSchema,
  })
...
export const InteractiveDemoSceneReorderResponseSchema =
...
export const InteractiveDemoHotspotResponseSchema = z
  .object({
    demo_hotspot: DemoHotspotSchema,
    working_draft: InteractiveDemoWorkingDraftSchema,
  })
  .strict();
export type InteractiveDemoHotspotResponse = z.infer<
  typeof InteractiveDemoHotspotResponseSchema
>;
export type InteractiveDemoHotspotCreateResponse =
  InteractiveDemoHotspotResponse;
export type InteractiveDemoHotspotUpdateResponse =
  InteractiveDemoHotspotResponse;

export const InteractiveDemoHotspotListResponseSchema = z
  .object({
