...
export const GuideProjectParamsSchema = z
  .object({
...
export const GuideVersionQuerySchema = z
  .object({
...
export const GuideFromCaptureSessionParamsSchema =
  GuideProjectParamsSchema.extend({
...
export const GuideEditionSchema = z
  .object({
    id: IdSchema,
    organization_id: IdSchema,
    project_id: IdSchema,
...
export const GuideWorkingDraftSchema = z
  .object({
    id: IdSchema,
    organization_id: IdSchema,
    project_id: IdSchema,
...
export const GuideAnnotationSchema = z
  .object({
    id: IdSchema,
    organization_id: IdSchema,
    project_id: IdSchema,
...
export const GuideScreenshotAnnotationSchema = z
  .object({
    id: IdSchema,
  ...
  .strict();
export type GuideScreenshotAnnotation = z.infer<
  typeof GuideScreenshotAnnotationSchema
>;
...
export const GuideSourceCaptureAssetSchema = z
  .object({
    id: IdSchema,
  ...
  .strict();
export type GuideSourceCaptureAsset = z.infer<
  typeof GuideSourceCaptureAssetSchema
>;
...
export const GuideWorkingDraftMutationResponseSchema = z
  .object({
    working_draft: GuideWorkingDraftSchema,
  })
  .strict();
export type GuideWorkingDraftMutationResponse = z.infer<
  typeof GuideWorkingDraftMutationResponseSchema
>;

export const GuideMarkdownExportSchema = z
  .object({
    filename: z.string(),
    markdown: z.string(),
  })
...
export const CreateGuideFromCaptureRequestSchema = z
  .object({
...
export const UpdateGuideEditionStatusRequestSchema = z
  .object({
    expected_edition_version: RowVersionSchema,
  })
  .strict();
...
export const UpdateGuideStepRequestSchema = z
  .object({
...
export const ReorderGuideBlocksRequestSchema = z
  .object({
    block_ids: z.array(TrimmedIdParamSchema).min(1),
    expected_working_draft_version: RowVersionSchema,
  })
  .strict();
export type ReorderGuideBlocksInput = z.infer<
  typeof ReorderGuideBlocksRequestSchema
>;

const GuideBlockPositionSchema = z
  .object({
...
export const CreateGuideBlockRequestSchema = z
  .object({
  ...
  .strict();
export type CreateGuideBlockInput = z.infer<
  typeof CreateGuideBlockRequestSchema
>;

export const UpdateGuideBlockRequestSchema = z
  .object({
    title: z.string().nullable().optional(),
    body: z.string().nullable().optional(),
    expected_working_draft_version: RowVersionSchema,
  ...
  .strict();
export type UpdateGuideBlockInput = z.infer<
  typeof UpdateGuideBlockRequestSchema
>;

export const UpdateGuideBlockScreenshotRequestSchema = z
  .object({
...
const UpdateGuideScreenshotAnnotationSchema = z
  .object({
...
export const UpdateGuideBlockAnnotationsRequestSchema = z
  .object({
...
export type GuideContentDeleteQuery = z.infer<
  typeof GuideContentDeleteQuerySchema
>;

export const ProjectGuideListResponseSchema = z
  .object({
    guide_editions: z.array(GuideSummarySchema),
  })
  .strict();
export type ProjectGuideListResponse = z.infer<
  typeof ProjectGuideListResponseSchema
>;

export const UpdateGuideResponseSchema = z
  .object({
    edition: GuideEditionSchema,
  })
  .strict();
...
export const UpdateGuideStepResponseSchema = z
  .object({
    guide_step: GuideStepSchema,
    working_draft: GuideWorkingDraftSchema,
  })
  .strict();
export type UpdateGuideStepResponse = z.infer<
  typeof UpdateGuideStepResponseSchema
>;

export const GuideBlocksResponseSchema = z
  .object({
    guide_blocks: z.array(GuideBlockSchema),
    working_draft: GuideWorkingDraftSchema,
  })
...
export const GuideBlockResponseSchema = z
  .object({
...
export const UploadGuideBlockScreenshotResponseSchema = z
  .object({
    guide_block: GuideBlockSchema,
    working_draft: GuideWorkingDraftSchema,
