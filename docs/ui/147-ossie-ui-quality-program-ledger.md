...
| 2026-08-07 | `2a3bd18` | native 200% Guide-family hardening continuation | isolated anonymous Guide reader/embed/password/access states and separate editor/viewer sessions were exercised at native Page zoom 200%; sampled widths stayed within 517–525px; public states and viewer were axe 0/0; editor retained the known two-textarea incomplete contrast probe; no mutations submitted; zoom restored to 100%, storage cleared, services stopped, and Documentation fixture reseeded | retain the unchecked broader 26.6 matrix, no-skip-target keyboard limitation for the bounded Guide reader sample, and all human/toolbar/route-ownership holds |
