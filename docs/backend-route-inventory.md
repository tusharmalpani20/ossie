...
| guide Publications and Publish Links | `/api/v1/projects/:project_id/guides/:guide_id/publications`, `/publish-links*`                                                                                                                                                  | `modules/publish`                |
| demo Publications and Publish Links  | `/api/v1/projects/:project_id/interactive-demos/:interactive_demo_id/publications`, `/publish-links*`                                                                                                                            | `modules/publish`                |
