...
const excluded = new Set([
  ...
  "documentation_schema.openapi_try_it_operation_allowance:INSERT",
  "documentation_schema.openapi_try_it_operation_allowance:DELETE",
  ...
  "documentation_schema.site_revision_openapi_try_it_policy:INSERT",
  "documentation_schema.site_revision_openapi_try_it_operation_allowance:INSERT",
