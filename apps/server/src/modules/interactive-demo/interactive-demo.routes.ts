...
import {
  ...
  type InteractiveDemoWorkingDraft,
...
export type InteractiveDemoRouteDependencies = {
  ...
  interactive_demo_service: {
    ...
    delete_demo_scene: (input: {
      ...
      demo_scene_id: string;
      expected_working_draft_version: number;
    }) => Promise<InteractiveDemoWorkingDraft>;
...
const interactive_demo_auth_context = (
  auth: AuthContext,
): InteractiveDemoAuthContext => ({
  organization_id: auth.organization.id,
  actor_org_user_id: auth.org_user.id,
});

const pick_create_demo_data = (
...
const pick_create_hotspot_data = (
...
const pick_update_hotspot_data = (
...
export const build_interactive_demo_routes = (
  ...
  return async (fastify: FastifyInstance) => {
    ...
    const handle_domain_error = (error: unknown, reply: FastifyReply) => {
      ...
      if (database_constraint === "authored_asset_version_guard") {
        return reply
          ...
          .send(
            error_response(
              "invalid_demo_scene_reference",
              "Demo scene references are invalid",
            ),
          );
      }
      ...
      if (error instanceof NoUsableCaptureEventsError) {
        return reply
          ...
          .send(
            error_response(
              "no_usable_capture_events",
              "Capture session has no screenshot-backed events",
            ),
          );
      }
      ...
      if (error instanceof DemoSceneNotFoundError) {
        return reply
          .status(404)
          .send(
            error_response("demo_scene_not_found", "Demo scene was not found"),
          );
      }
      ...
      if (error instanceof DemoHotspotNotFoundError) {
        return reply
          ...
          .send(
            error_response(
              "demo_hotspot_not_found",
              "Demo hotspot was not found",
            ),
          );
      }
      ...
      if (error instanceof EmptyInteractiveDemoUpdateError) {
        return reply
          ...
          .send(
            error_response(
              "empty_interactive_demo_update",
              "At least one interactive demo field must be provided",
            ),
          );
      }
      ...
      if (error instanceof EmptyDemoSceneUpdateError) {
        return reply
          ...
          .send(
            error_response(
              "empty_demo_scene_update",
              "At least one demo scene field must be provided",
            ),
          );
      }
      ...
      if (error instanceof EmptyDemoSceneOrderError) {
        return reply
          ...
          .send(
            error_response(
              "empty_demo_scene_order",
              "At least one demo scene id must be provided",
            ),
          );
      }
      ...
      if (error instanceof EmptyDemoHotspotUpdateError) {
        return reply
          ...
          .send(
            error_response(
              "empty_demo_hotspot_update",
              "At least one demo hotspot field must be provided",
            ),
          );
      }
      ...
      if (error instanceof EmptyDemoHotspotOrderError) {
        return reply
          ...
          .send(
            error_response(
              "empty_demo_hotspot_order",
              "At least one demo hotspot id must be provided",
            ),
          );
      }
      ...
      if (error instanceof InvalidDemoHotspotOrderError) {
        return reply
          ...
          .send(
            error_response(
              "invalid_demo_hotspot_order",
              "Demo hotspot order is invalid",
            ),
          );
      }
        ...
        return reply
          ...
          .send(
            error_response(
              ...
              "Demo hotspot coordinates are invalid",
            ),
          );
      }
      ...
      if (error instanceof InvalidDemoHotspotTargetError) {
        return reply
          ...
          .send(
            error_response(
              "invalid_demo_hotspot_target",
              "Demo hotspot target is invalid",
            ),
          );
      }
    ...
    fastify.post<{
      ...
      async (request, reply) => {
        try {
          ...
          const result =
            await dependencies.interactive_demo_service.create_interactive_demo_from_capture(
              {
                auth,
      ...
      async (request, reply) => {
        try {
          ...
          const interactive_demo =
            await dependencies.interactive_demo_service.create_interactive_demo(
              {
                auth,
                project_id: request.params.project_id,
    ...
    fastify.get<{
      ...
      "/:project_id/interactive-demos",
      { schema: { querystring: InteractiveDemoVersionQuerySchema } },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const interactive_demos =
            await dependencies.interactive_demo_service.list_interactive_demos({
              auth,
              project_id: request.params.project_id,
          ...
          return reply
            .status(200)
            .send({ interactive_demo_editions: interactive_demos });
        } catch (error) {
          return handle_domain_error(error, reply);
        }
      },
    ...
    fastify.get<{
      ...
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const interactive_demo =
            await dependencies.interactive_demo_service.get_interactive_demo({
              auth,
              project_id: request.params.project_id,
    ...
    fastify.patch<{
      ...
      {
        schema: {
          body: UpdateInteractiveDemoRequestSchema,
          querystring: InteractiveDemoVersionQuerySchema,
        },
      },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const interactive_demo =
            await dependencies.interactive_demo_service.update_interactive_demo(
              {
                auth,
                project_id: request.params.project_id,
                interactive_demo_id: request.params.interactive_demo_id,
    ...
    for (const command of ["archive", "restore"] as const) {
      fastify.post<{
        ...
        `/:project_id/interactive-demos/:interactive_demo_id/${command}`,
        {
          schema: {
            querystring: InteractiveDemoVersionQuerySchema,
            body: UpdateInteractiveDemoEditionStatusRequestSchema,
          },
        },
        async (request, reply) => {
          try {
            ...
            const edition =
              await dependencies.interactive_demo_service.update_interactive_demo_status(
                {
                  auth,
                  project_id: request.params.project_id,
                  interactive_demo_id: request.params.interactive_demo_id,
                  ...
                  expected_edition_version:
                    request.body.expected_edition_version,
                },
              );
    ...
    fastify.post<{
      ...
      {
        schema: {
          body: CreateDemoSceneRequestSchema,
          querystring: InteractiveDemoVersionQuerySchema,
        },
      },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const demo_scene =
            await dependencies.interactive_demo_service.create_demo_scene({
              auth,
              project_id: request.params.project_id,
              interactive_demo_id: request.params.interactive_demo_id,
              project_version_id: request.query.project_version_id,
    ...
    fastify.get<{
      ...
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const demo_scenes =
            await dependencies.interactive_demo_service.list_demo_scenes({
              auth,
              project_id: request.params.project_id,
              interactive_demo_id: request.params.interactive_demo_id,
              project_version_id: request.query.project_version_id,
    ...
    fastify.patch<{
      ...
      {
        schema: {
          body: UpdateDemoSceneRequestSchema,
          querystring: InteractiveDemoVersionQuerySchema,
        },
      },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const demo_scene =
            await dependencies.interactive_demo_service.update_demo_scene({
              auth,
              project_id: request.params.project_id,
              interactive_demo_id: request.params.interactive_demo_id,
              project_version_id: request.query.project_version_id,
    ...
    fastify.put<{
      ...
      {
        schema: {
          body: ReorderDemoScenesRequestSchema,
          querystring: InteractiveDemoVersionQuerySchema,
        },
      },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const demo_scenes =
            await dependencies.interactive_demo_service.reorder_demo_scenes({
              auth,
              project_id: request.params.project_id,
              interactive_demo_id: request.params.interactive_demo_id,
              project_version_id: request.query.project_version_id,
    ...
    fastify.delete<{
      ...
      "/:project_id/interactive-demos/:interactive_demo_id/scenes/:scene_id",
      { schema: { querystring: InteractiveDemoContentDeleteQuerySchema } },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const working_draft =
    ...
    fastify.post<{
      ...
      {
        schema: {
          body: CreateDemoHotspotRequestSchema,
          querystring: InteractiveDemoVersionQuerySchema,
        },
      },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const demo_hotspot =
            await dependencies.interactive_demo_service.create_demo_hotspot({
              auth,
              project_id: request.params.project_id,
              interactive_demo_id: request.params.interactive_demo_id,
              project_version_id: request.query.project_version_id,
    ...
    fastify.get<{
      ...
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const demo_hotspots =
            await dependencies.interactive_demo_service.list_demo_hotspots({
              auth,
              project_id: request.params.project_id,
              interactive_demo_id: request.params.interactive_demo_id,
              project_version_id: request.query.project_version_id,
    ...
    fastify.patch<{
      ...
      {
        schema: {
          body: UpdateDemoHotspotRequestSchema,
          querystring: InteractiveDemoVersionQuerySchema,
        },
      },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const demo_hotspot =
            await dependencies.interactive_demo_service.update_demo_hotspot({
              auth,
              project_id: request.params.project_id,
              interactive_demo_id: request.params.interactive_demo_id,
              project_version_id: request.query.project_version_id,
    ...
    fastify.put<{
      ...
      {
        schema: {
          body: ReorderDemoHotspotsRequestSchema,
          querystring: InteractiveDemoVersionQuerySchema,
        },
      },
      async (request, reply) => {
        try {
          const auth = await require_auth(session_token_from_request(request));
          const demo_hotspots =
            await dependencies.interactive_demo_service.reorder_demo_hotspots({
              auth,
              project_id: request.params.project_id,
              interactive_demo_id: request.params.interactive_demo_id,
              project_version_id: request.query.project_version_id,
